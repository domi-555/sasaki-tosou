        ...
        <div className="main-content">
            <div className="kuchikomi_title">
                ...
                <div className="kuchikomi_title_r">
                    <h3>佐々木塗装の口コミ<br />
                    総合評価:4.7<span className="g_kuchi_star">★★★★★</span> <br className="smp" />口コミ数:34</h3>
                </div>
            </div>
        
            <ul className="kuchikomi_box">
                <li><span className="star">★★★★★</span> <span className="bold">2022/10/20 中田良枝</span><br />
                丁寧で、キレイに作業して頂きました。ありがとうございます。</li>
                <li><span className="star">★★★★★</span> <span className="bold">2022/10/19 レッドブルー</span><br />
                外壁塗装ありがとうございました。社長、スタッフさんの対応に心がこもっており、親切丁寧な説明でとても安心できました。工事完了後はまるで新築の様な外観に仕上がっていて大変感動しました。</li>
                <li><span className="star">★★★★☆</span> <span className="bold">2022/10/12 久保雄造</span><br />
                佐々木塗装さんには見積もりから、丁寧な説明して頂きましまた、３回塗りを契約しましたが塗装担当のかたが小さなところまできれいに丁寧に仕上げて頂きました、知人にお勧めしたいと思います</li>
                <li><span className="star">★★★★★</span> <span className="bold">2022/10/5 松木俊博</span><br />
